...
public class CaldroidFragment extends DialogFragment {
    ...
    public void setNewTodayDate(Date date){
        refreshView(CalendarHelper.convertDateToDateTime(date));
    }
    ...
    protected void refreshMonthTitleTextView() {
        ...
        monthTitleTextView.setText(monthTitle.substring(0, 1).toUpperCase() + monthTitle.substring(1).toLowerCase());
    }
    ...
    public void refreshView(DateTime dateTime) {
        ...
        for (CaldroidGridAdapter adapter : datePagerAdapters) {
            ...
            if(dateTime!=null){
                adapter.updateToday(dateTime);
            }
            else{
                adapter.updateToday(mySelectedDate);
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Typeface typeface = Typeface.createFromAsset(getActivity().getAssets(), "SohoGothicPro-Regular.otf");
    ...
    public Date getMySelectedDate() {
        return mySelectedDate;
    }

    public void setMySelectedDate(Date mySelectedDate) {
        this.mySelectedDate = mySelectedDate;
    }
