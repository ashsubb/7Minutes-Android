...
public class CaldroidGridAdapter extends BaseAdapter {
    ...
    public void updateToday(DateTime dateTime) {
        today = dateTime;
    }

    public void updateToday(Date date) {
        Log.d("CaldroidGridAdapter","updateToday");
        if(date==null){
            today = CalendarHelper.convertDateToDateTime(new Date());
        }
        else{
            today = CalendarHelper.convertDateToDateTime(date);
        }

    }

    protected DateTime getToday() {
        Log.d("CaldroidGridAdapter","getToday");
        if (today == null) {
            today = CalendarHelper.convertDateToDateTime(new Date());
            Log.d("CaldroidGridAdapter","getToday today is null");
        }
        return today;
    }
